...
def parse_args():
    ...
    parser.add_argument(
        "--dataset_name",
        type=str,
        default="instruction-tuning-sd/cartoonization",
        help=(
    ...
    parser.add_argument(
        "--val_image_url",
        type=str,
        default="https://hf.co/datasets/diffusers/diffusers-images-docs/resolve/main/mountain.png",
        help="URL to the original image that you would like to edit (used during inference for debugging purposes).",
    )
    parser.add_argument(
        "--validation_prompt", type=str, default="Generate a cartoonized version of the natural image", help="A prompt that is sampled during training for inference."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/mnt/e/Data/ProjectData/2025.WindowViewPressConference/s1_view_image_beautification/s6_instruct-pix2pix/finetuned/",
