...
def parse_args():
    ...
    parser.add_argument(
        "--val_image_url",
        type=str,
        default="/mnt/e/Software/dropbox2024/Dropbox/_proposal/2025.MainlandHK_ITF/Task/Siyuan/data/01_facade_texture/Tile_+007_+006_B355881859301063A0/",
        help="URL to the original image that you would like to edit (used during inference for debugging purposes).",
    )

    # E:\Software\dropbox2024\Dropbox\_proposal\2025.MainlandHK_ITF\Task\Siyuan\data\01_facade_texture
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/mnt/e/Data/ProjectData/2025.7.25.SimulationReconstruction/images/45degrees/instructpix2pix",
...
def inference_images(image_num,args, img, generator, accelerator, pipeline,name, validation_prompt, num_inference_steps,image_guidance_scale, guidance_scale):
    ...
    for i in range(len(edited_images)):
        edited_images[i].save("/mnt/e/Data/ProjectData/2025.7.25.SimulationReconstruction/siyuan_image_enhancement/output/Tile_+007_+006_B355881859301063A0/"+name)
