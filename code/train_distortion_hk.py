...
parser.add_argument('--output', type=str, default='/lustre1/g/rec_fx/model_train_log/sam_windowview_distortion')
parser.add_argument('--dataset', type=str,
                    default='WindowviewDistortion', help='experiment_name')
parser.add_argument('--list_dir', type=str,
                    default='/lustre1/g/rec_fx/data_processing/sam_windowview/ImageSets/ImageSetsAll/distortion_hk/', help='list dir')
...
if __name__ == "__main__":
    ...
    trainer = {'WindowviewDistortion': trainer_windowview}
