...
if __name__ == '__main__':
    ...
    parser.add_argument('--volume_path', type=str, default='/lustre1/g/rec_fx/dp_paper/2024_3DGreeneryExposure/test_model/input/')
    parser.add_argument('--dataset', type=str, default='Windowview', help='Experiment name')
    parser.add_argument('--num_classes', type=int, default=4)
    parser.add_argument('--list_dir', type=str, default='/lustre1/g/rec_fx/data_processing/sam_windowview/ImageSets/ImageSetsAll/japan_only/', help='list_dir')
    parser.add_argument('--output_dir', type=str, default='/lustre1/g/rec_fx/model_train_log/sam_windowview/Windowview_512_vit_b_0.5_0.5_2024-11-03_07-28-31_best/')
    ...
    parser.add_argument('--lora_ckpt', type=str, default='/lustre1/g/rec_fx/model_train_log/sam_windowview/Windowview_512_vit_b_0.5_0.5_2024-11-03_07-28-31/checkpoint_best.pth', help='The checkpoint from LoRA')
    parser.add_argument('--vit_name', type=str, default='vit_b', help='Select one vit model')
    parser.add_argument('--rank', type=int, default=4, help='Rank for LoRA adaptation')
    parser.add_argument('--module', type=str, default='sam_lora_image_encoder')
    parser.add_argument('--split', type=str, default='model_test')    
