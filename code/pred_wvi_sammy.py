...
if __name__ == '__main__':
    ...
    parser.add_argument('--volume_path', type=str, default='/lustre1/g/rec_fx/dp_paper/20250226_SammyHelp/input/batch_2/')
    parser.add_argument('--dataset', type=str, default='Windowview', help='Experiment name')
    parser.add_argument('--num_classes', type=int, default=4)
    parser.add_argument('--list_dir', type=str, default='/lustre1/g/rec_fx/data_processing/sam_windowview/ImageSets/ImageSetsAll/sammy/', help='list_dir')
    parser.add_argument('--output_dir', type=str, default='/lustre1/g/rec_fx/dp_paper/20250226_SammyHelp/output/batch_2/')
    ...
    parser.add_argument('--split', type=str, default='batch_2')    
