...
if __name__ == '__main__':
    ...
    parser.add_argument('--volume_path', type=str, default='/lustre1/g/rec_fx/model_train_log/deeplabv3_new/verification/20240426_greenery_exposure/input/')
    parser.add_argument('--dataset', type=str, default='Windowview', help='Experiment name')
    parser.add_argument('--num_classes', type=int, default=4)
    parser.add_argument('--list_dir', type=str, default='/lustre1/g/rec_fx/data_processing/sam_windowview/ImageSets/ImageSetsAll/hk_extra_10_tpu/', help='list_dir')
    parser.add_argument('--output_dir', type=str, default='/lustre1/g/rec_fx/dp_paper/2024_WindowViewHK/tpu_10_sam/')
