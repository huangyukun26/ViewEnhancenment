...
parser.add_argument('--root_path', type=str,
                    default='/lustre1/g/rec_fx/data_processing/sam_landfill/', help='root dir for data')
parser.add_argument('--output', type=str, default='/lustre1/g/rec_fx/model_train_log/sam_landfill/results')
parser.add_argument('--dataset', type=str,
                    default='Landfill', help='experiment_name')
parser.add_argument('--list_dir', type=str,
                    default='/lustre1/g/rec_fx/data_processing/sam_landfill/ImageSets/', help='list dir')
