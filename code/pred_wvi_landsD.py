...
if __name__ == '__main__':
    ...
    parser.add_argument('--volume_path', type=str, default='/lustre1/g/rec_fx/dp_paper/20260121_RestHKLandsDModels/')
    parser.add_argument('--dataset', type=str, default='Windowview', help='Experiment name')
    parser.add_argument('--num_classes', type=int, default=7)
    parser.add_argument('--list_dir', type=str, default='/lustre1/g/rec_fx/data_processing/sam_windowview/ImageSets/ImageSetsAll/landsD_finetune/', help='list_dir')
    parser.add_argument('--output_dir', type=str, default='/lustre1/g/rec_fx/dp_paper/20260309_landsD_seg/output/')
    ...
    parser.add_argument('--lora_ckpt', type=str, default='/lustre1/g/rec_fx/model_train_log/sam_windowview/Windowview_512_vit_b_0.5_0.5_2026-03-08_19-50-12/checkpoint_best.pth', help='The checkpoint from LoRA')
