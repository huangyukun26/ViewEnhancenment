...
if __name__ == '__main__':
    ...
    parser.add_argument('--volume_path', type=str, default='/lustre1/g/rec_fx/dp_paper/2024_3DGreeneryExposure/new_bldg_2w_2/')
    ...
    parser.add_argument('--output_dir', type=str, default='/lustre1/g/rec_fx/dp_paper/2024_3DGreeneryExposure/2w_new_bldg_2/')
    ...
    parser.add_argument('--split', type=str, default='japan_test_2')    
