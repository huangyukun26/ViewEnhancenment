...
class Windowview_dataset(Dataset):
    def __init__(self, base_dir, list_dir, split, transform=None):
        ...
        # self.sample_list.remove('batch_8/298872_1108233556_13_1_114.22145_22.32071_157.2_332.77474.png')
    ...
    def __getitem__(self, idx):
            ...
            ann_np_grey=np.ones((900,900))

            try:
                img_np = np.asarray(Image.open(os.path.join(self.data_dir, slice_name)).convert('RGB'))/255
            except (UnidentifiedImageError, OSError) as e:
                print("cannot find:"+slice_name)
                img_np=np.ones((900,900,3))
