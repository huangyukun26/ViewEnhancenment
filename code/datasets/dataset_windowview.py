...
class Windowview_dataset(Dataset):
    ...
    def __getitem__(self, idx):
            ...
            ann=Image.open(os.path.join(self.data_dir, 'ann', 'ann_landsD_seven_type', slice_name))

            ann_np_grey=np.asarray(ann)

            img_np = np.asarray(Image.open(os.path.join(self.data_dir, 'img', 'images_landsD', slice_name)).convert('RGB'))/255
