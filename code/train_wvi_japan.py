...
parser.add_argument('--list_dir', type=str,
                    default='/lustre1/g/rec_fx/data_processing/sam_windowview/ImageSets/ImageSetsAll/new_japan/', help='list dir')
...
parser.add_argument('--lora_ckpt', type=str, default='/lustre1/g/rec_fx/model_train_log/sam_windowview/Windowview_512_vit_b_0.5_0.5_2024-08-02_03-26-25/checkpoint_best.pth', help='Finetuned lora checkpoint')
...
parser.add_argument('--dice_param', type=float, default=0.0)
